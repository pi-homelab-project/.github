...
This project is intended to be a collaborative space for [@messedpRyan](https://github.com/messedupryan) and [@papayaofdestiny](http://github.com/papayaofdestiny). This project will contain resources related to using Raspberry Pi devices to host a kubernetes cluster running k3s. It will also contain a Jenkins Pipeline Library and various apps that we are running on our cluster. The primary goal if the project is learning.
